...
import {
  ...
  launchChannelValidator,
  launchStepValidator,
  launchProjectionValidator,
} from "./validators";
...
export default defineSchema({
  ...
  // One generated viral launch campaign: a core hook, copy-ready assets per channel, a launch sequence, and a
  // transparent reach->customers->CAC projection. Generated by an OpenAI action, grounded in the product's research.
  launchCampaigns: defineTable({
    productId: v.id("products"),
    userId: v.string(),
    status: v.union(v.literal("running"), v.literal("complete"), v.literal("error")),
    error: v.optional(v.string()),
